 ...
 */
class Note extends \Fdl\Entity\Note implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'content', 'user_id', 'category_id', 'create_date', '' . "\0" . 'Fdl\\Entity\\Note' . "\0" . 'user', '' . "\0" . 'Fdl\\Entity\\Note' . "\0" . 'category', '' . "\0" . 'Fdl\\Entity\\Note' . "\0" . 'votes');
        }
    ...
    public function getCategory_id()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCategory_id', array());

        return parent::getCategory_id();
    }
    ...
    public function setCategory_id($category_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategory_id', array($category_id));

        return parent::setCategory_id($category_id);
    }
