 ...
 */
class Category extends \Fdl\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'create_date', '' . "\0" . 'Fdl\\Entity\\Category' . "\0" . 'fdls');
        }
    ...
    public function getFdls()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFdls', array());

        return parent::getFdls();
    }
    ...
    public function setFdls($fdls)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFdls', array($fdls));

        return parent::setFdls($fdls);
    }
